namespace Trumpf.Coparoo.Web.Controls.Table
{
    ...
    /// <summary>
    /// Table head row control object.
    /// </summary>
    public class TableHeadRow : ControlObject
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<TableHeadCell> Cells => FindAll<TableHeadCell>();
        ...
        public TableHeadCell CellAt(int index)
        {
